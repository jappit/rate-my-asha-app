...
public class RateMyAppCustomResourcesSample extends MIDlet
{
	Form form = null;
	...
	{
		form = new Form("Rate My App Custom Resources");
		form.append("Testing Rate My App with custom resource files");
